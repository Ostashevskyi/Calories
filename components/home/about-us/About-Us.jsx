    ...
    <section className="bg-[url('/images/about-us-bg.jpg')] bg-cover bg-no-repeat max-h-[50%]">
      ...
      <div>
        <p className="text-center text-white text-[26px] font-normal px-16 font-serif pb-[200px]">
          At CalorieTrack, we're passionate about empowering you to achieve your
          health and fitness goals through mindful nutrition. Our team of
          ...
          in nutrition and technology, we've crafted CalorieTrack to be your
          trusted companion on your wellness journey. We believe that
          ...
          confidence. Whether you're a fitness enthusiast, a health-conscious
          individual, or someone looking to make lasting dietary changes,
          CalorieTrack is here for you. Join us today, and together, let's
          embark on a healthier, happier life.
        </p>
      </div>
    </section>
  );
